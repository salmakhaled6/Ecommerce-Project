...
function PoductPage4() {
  return (
    <div className='ProductPage4'>
       <div><h2>Related Products</h2></div>

       <div className="ProductPage3-cards">
        <div className="p3-product-card">
        <div className="p3-card-top">
        ...
        <div className="card-image-page3">
          <img
            src="https://elessi.b-cdn.net/wp-content/uploads/2019/10/CLASSIC-WOODEN-CHAIR-2-401x471.jpg"
            alt=""
          />
